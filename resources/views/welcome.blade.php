                ...
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="bg-teal-300 hover:bg-teal-500 text-lg font-bold py-2 px-4 rounded">Register</a>
                        @endif
                    @endauth
                </div>
            @endif
                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    ...
                    <div class="p-3" id="text-animation">
                        <svg viewBox="0 0 600 100">
                            <!-- Symbol-->
                            <symbol id="s-text">
                                <text text-anchor="middle" x="50%" y="50%" dy=".35em">Questionnaire</text>
                            </symbol>
                            <!-- Duplicate symbols-->
                    ...
                    <div class="flex justify-center pt-8 sm:pt-0 mb-6">
                        <a href="{{ route('questionnaire') }}" class="bg-teal-300 hover:bg-teal-500 text-lg font-bold py-2 px-4 rounded">
                                C'est parti !
                        </a>
                    </div>
